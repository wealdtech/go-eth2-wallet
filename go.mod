...
require (
	...
	github.com/wealdtech/go-eth2-wallet-hd v1.10.0
	github.com/wealdtech/go-eth2-wallet-nd v1.8.0
	github.com/wealdtech/go-eth2-wallet-store-filesystem v1.7.0
	github.com/wealdtech/go-eth2-wallet-store-s3 v1.6.0
